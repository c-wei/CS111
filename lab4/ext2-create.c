...
#define UNLIMITED_MNT -1
#define EXT2_STATE 1
#define EXT2_CONTINUE_ERRORS 1
#define CHECK_INTERVAL 1
#define EXT2_LINUX_OS 0
...
void write_superblock(int fd) {
	...
	superblock.s_max_mnt_count     = UNLIMITED_MNT; /* Make this unlimited */
	superblock.s_magic = EXT2_SUPER_MAGIC; /* ext2 Signature */
	superblock.s_state             = EXT2_STATE; /* File system is clean */
	superblock.s_errors            = EXT2_CONTINUE_ERRORS; /* Ignore the error (continue on) */
	...
	superblock.s_creator_os        = EXT2_LINUX_OS; /* Linux */
...
void write_block_group_descriptor_table(int fd) {
	...
	block_group_descriptor.bg_block_bitmap = BLOCK_BITMAP_BLOCKNO;        /* Blocks bitmap block */
